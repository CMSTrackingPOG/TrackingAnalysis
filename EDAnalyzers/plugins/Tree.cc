...
void ResTree::CreateBranches(int buff = 32000, bool runOnData = false)
{
   ...
   tree->Branch("pv_trk_isHighPurity", "std::vector<std::vector<int> >", &pv_trk_isHighPurity, buff);
   ...
   tree->Branch("pv_trk_hasPixelBarrelLayer1", "std::vector<std::vector<int> >", &pv_trk_hasPixelBarrelLayer1, buff);
   tree->Branch("pv_trk_hasPixelEndcapLayer1", "std::vector<std::vector<int> >", &pv_trk_hasPixelEndcapLayer1, buff);
   tree->Branch("pv_trk_hasPixelBarrelLayer2", "std::vector<std::vector<int> >", &pv_trk_hasPixelBarrelLayer2, buff);
   tree->Branch("pv_trk_hasPixelEndcapLayer2", "std::vector<std::vector<int> >", &pv_trk_hasPixelEndcapLayer2, buff);
   tree->Branch("pv_trk_hasPixelBarrelLayer3", "std::vector<std::vector<int> >", &pv_trk_hasPixelBarrelLayer3, buff);
   tree->Branch("pv_trk_hasPixelEndcapLayer3", "std::vector<std::vector<int> >", &pv_trk_hasPixelEndcapLayer3, buff);
   tree->Branch("pv_trk_hasPixelBarrelLayer4", "std::vector<std::vector<int> >", &pv_trk_hasPixelBarrelLayer4, buff);
   tree->Branch("pv_trk_hasPixelEndcapLayer4", "std::vector<std::vector<int> >", &pv_trk_hasPixelEndcapLayer4, buff);
   ...
   tree->Branch("pv_mc_isPrimaryVertex", "std::vector<std::vector<int> >", &pv_mc_isPrimaryVertex, buff);
   tree->Branch("pv_mc_isSecondaryVertex", "std::vector<std::vector<int> >", &pv_mc_isSecondaryVertex, buff);
   tree->Branch("pv_mc_isTertiaryVertex", "std::vector<std::vector<int> >", &pv_mc_isTertiaryVertex, buff);
   tree->Branch("pv_mc_isSignalEvent", "std::vector<std::vector<int> >", &pv_mc_isSignalEvent, buff);
   tree->Branch("pv_mc_isBWeakDecay", "std::vector<std::vector<int> >", &pv_mc_isBWeakDecay, buff);
   tree->Branch("pv_mc_isCWeakDecay", "std::vector<std::vector<int> >", &pv_mc_isCWeakDecay, buff);
   tree->Branch("pv_mc_isTauDecay", "std::vector<std::vector<int> >", &pv_mc_isTauDecay, buff);
   tree->Branch("pv_mc_isKsDecay", "std::vector<std::vector<int> >", &pv_mc_isKsDecay, buff);
   tree->Branch("pv_mc_isLambdaDecay", "std::vector<std::vector<int> >", &pv_mc_isLambdaDecay, buff);
   tree->Branch("pv_mc_isJpsiDecay", "std::vector<std::vector<int> >", &pv_mc_isJpsiDecay, buff);
   tree->Branch("pv_mc_isXiDecay", "std::vector<std::vector<int> >", &pv_mc_isXiDecay, buff);
   tree->Branch("pv_mc_isOmegaDecay", "std::vector<std::vector<int> >", &pv_mc_isOmegaDecay, buff);
   tree->Branch("pv_mc_isSigmaPlusDecay", "std::vector<std::vector<int> >", &pv_mc_isSigmaPlusDecay, buff);
   tree->Branch("pv_mc_isSigmaMinusDecay", "std::vector<std::vector<int> >", &pv_mc_isSigmaMinusDecay, buff);
   tree->Branch("pv_mc_isLongLivedDecay", "std::vector<std::vector<int> >", &pv_mc_isLongLivedDecay, buff);
   
   tree->Branch("pv_mc_isKnownProcess", "std::vector<std::vector<int> >", &pv_mc_isKnownProcess, buff);
   tree->Branch("pv_mc_isUndefinedProcess", "std::vector<std::vector<int> >", &pv_mc_isUndefinedProcess, buff);
   tree->Branch("pv_mc_isUnknownProcess", "std::vector<std::vector<int> >", &pv_mc_isUnknownProcess, buff);
   tree->Branch("pv_mc_isPrimaryProcess", "std::vector<std::vector<int> >", &pv_mc_isPrimaryProcess, buff);
   tree->Branch("pv_mc_isHadronicProcess", "std::vector<std::vector<int> >", &pv_mc_isHadronicProcess, buff);
   tree->Branch("pv_mc_isDecayProcess", "std::vector<std::vector<int> >", &pv_mc_isDecayProcess, buff);
   tree->Branch("pv_mc_isComptonProcess", "std::vector<std::vector<int> >", &pv_mc_isComptonProcess, buff);
   tree->Branch("pv_mc_isAnnihilationProcess", "std::vector<std::vector<int> >", &pv_mc_isAnnihilationProcess, buff);
   tree->Branch("pv_mc_isEIoniProcess", "std::vector<std::vector<int> >", &pv_mc_isEIoniProcess, buff);
   tree->Branch("pv_mc_isHIoniProcess", "std::vector<std::vector<int> >", &pv_mc_isHIoniProcess, buff);
   tree->Branch("pv_mc_isMuIoniProcess", "std::vector<std::vector<int> >", &pv_mc_isMuIoniProcess, buff);
   tree->Branch("pv_mc_isPhotonProcess", "std::vector<std::vector<int> >", &pv_mc_isPhotonProcess, buff);
   tree->Branch("pv_mc_isMuPairProdProcess", "std::vector<std::vector<int> >", &pv_mc_isMuPairProdProcess, buff);
   tree->Branch("pv_mc_isConversionsProcess", "std::vector<std::vector<int> >", &pv_mc_isConversionsProcess, buff);
   tree->Branch("pv_mc_isEBremProcess", "std::vector<std::vector<int> >", &pv_mc_isEBremProcess, buff);
   tree->Branch("pv_mc_isSynchrotronRadiationProcess", "std::vector<std::vector<int> >", &pv_mc_isSynchrotronRadiationProcess, buff);
   tree->Branch("pv_mc_isMuBremProcess", "std::vector<std::vector<int> >", &pv_mc_isMuBremProcess, buff);
   tree->Branch("pv_mc_isMuNuclProcess", "std::vector<std::vector<int> >", &pv_mc_isMuNuclProcess, buff);
   tree->Branch("pv_mc_isUnknown", "std::vector<std::vector<int> >", &pv_mc_isUnknown, buff);
   
   tree->Branch("pv_mc_inVolume", "std::vector<std::vector<int> >", &pv_mc_inVolume, buff);
   ...
   tree->Branch("trk_mc_isFake", "std::vector<std::vector<int> >", &trk_mc_isFake, buff);
   tree->Branch("trk_mc_isBad", "std::vector<std::vector<int> >", &trk_mc_isBad, buff);
   tree->Branch("trk_mc_isBadInnerHits", "std::vector<std::vector<int> >", &trk_mc_isBadInnerHits, buff);
   tree->Branch("trk_mc_isSharedInnerHits", "std::vector<std::vector<int> >", &trk_mc_isSharedInnerHits, buff);
   tree->Branch("trk_mc_isSignalEvent", "std::vector<std::vector<int> >", &trk_mc_isSignalEvent, buff);
   tree->Branch("trk_mc_isTrackerSimHits", "std::vector<std::vector<int> >", &trk_mc_isTrackerSimHits, buff);
   tree->Branch("trk_mc_isBottom", "std::vector<std::vector<int> >", &trk_mc_isBottom, buff);
   tree->Branch("trk_mc_isCharm", "std::vector<std::vector<int> >", &trk_mc_isCharm, buff);
   tree->Branch("trk_mc_isLight", "std::vector<std::vector<int> >", &trk_mc_isLight, buff);
   tree->Branch("trk_mc_isMuon", "std::vector<std::vector<int> >", &trk_mc_isMuon, buff);
   
   tree->Branch("trk_mc_isBWeakDecay", "std::vector<std::vector<int> >", &trk_mc_isBWeakDecay, buff);
   tree->Branch("trk_mc_isCWeakDecay", "std::vector<std::vector<int> >", &trk_mc_isCWeakDecay, buff);
   tree->Branch("trk_mc_isChargePionDecay", "std::vector<std::vector<int> >", &trk_mc_isChargePionDecay, buff);
   tree->Branch("trk_mc_isChargeKaonDecay", "std::vector<std::vector<int> >", &trk_mc_isChargeKaonDecay, buff);
   tree->Branch("trk_mc_isTauDecay", "std::vector<std::vector<int> >", &trk_mc_isTauDecay, buff);
   tree->Branch("trk_mc_isKsDecay", "std::vector<std::vector<int> >", &trk_mc_isKsDecay, buff);
   tree->Branch("trk_mc_isLambdaDecay", "std::vector<std::vector<int> >", &trk_mc_isLambdaDecay, buff);
   tree->Branch("trk_mc_isJpsiDecay", "std::vector<std::vector<int> >", &trk_mc_isJpsiDecay, buff);
   tree->Branch("trk_mc_isXiDecay", "std::vector<std::vector<int> >", &trk_mc_isXiDecay, buff);
   tree->Branch("trk_mc_isOmegaDecay", "std::vector<std::vector<int> >", &trk_mc_isOmegaDecay, buff);
   tree->Branch("trk_mc_isSigmaPlusDecay", "std::vector<std::vector<int> >", &trk_mc_isSigmaPlusDecay, buff);
   tree->Branch("trk_mc_isSigmaMinusDecay", "std::vector<std::vector<int> >", &trk_mc_isSigmaMinusDecay, buff);
   tree->Branch("trk_mc_isLongLivedDecay", "std::vector<std::vector<int> >", &trk_mc_isLongLivedDecay, buff);
   
   tree->Branch("trk_mc_isKnownProcess", "std::vector<std::vector<int> >", &trk_mc_isKnownProcess, buff);
   tree->Branch("trk_mc_isUndefinedProcess", "std::vector<std::vector<int> >", &trk_mc_isUndefinedProcess, buff);
   tree->Branch("trk_mc_isUnknownProcess", "std::vector<std::vector<int> >", &trk_mc_isUnknownProcess, buff);
   tree->Branch("trk_mc_isPrimaryProcess", "std::vector<std::vector<int> >", &trk_mc_isPrimaryProcess, buff);
   tree->Branch("trk_mc_isHadronicProcess", "std::vector<std::vector<int> >", &trk_mc_isHadronicProcess, buff);
   tree->Branch("trk_mc_isDecayProcess", "std::vector<std::vector<int> >", &trk_mc_isDecayProcess, buff);
   tree->Branch("trk_mc_isComptonProcess", "std::vector<std::vector<int> >", &trk_mc_isComptonProcess, buff);
   tree->Branch("trk_mc_isAnnihilationProcess", "std::vector<std::vector<int> >", &trk_mc_isAnnihilationProcess, buff);
   tree->Branch("trk_mc_isEIoniProcess", "std::vector<std::vector<int> >", &trk_mc_isEIoniProcess, buff);
   tree->Branch("trk_mc_isHIoniProcess", "std::vector<std::vector<int> >", &trk_mc_isHIoniProcess, buff);
   tree->Branch("trk_mc_isMuIoniProcess", "std::vector<std::vector<int> >", &trk_mc_isMuIoniProcess, buff);
   tree->Branch("trk_mc_isPhotonProcess", "std::vector<std::vector<int> >", &trk_mc_isPhotonProcess, buff);
   tree->Branch("trk_mc_isMuPairProdProcess", "std::vector<std::vector<int> >", &trk_mc_isMuPairProdProcess, buff);
   tree->Branch("trk_mc_isConversionsProcess", "std::vector<std::vector<int> >", &trk_mc_isConversionsProcess, buff);
   tree->Branch("trk_mc_isEBremProcess", "std::vector<std::vector<int> >", &trk_mc_isEBremProcess, buff);
   tree->Branch("trk_mc_isSynchrotronRadiationProcess", "std::vector<std::vector<int> >", &trk_mc_isSynchrotronRadiationProcess, buff);
   tree->Branch("trk_mc_isMuBremProcess", "std::vector<std::vector<int> >", &trk_mc_isMuBremProcess, buff);
   tree->Branch("trk_mc_isMuNuclProcess", "std::vector<std::vector<int> >", &trk_mc_isMuNuclProcess, buff);
   
   tree->Branch("trk_mc_isFromBWeakDecayMuon", "std::vector<std::vector<int> >", &trk_mc_isFromBWeakDecayMuon, buff);
   tree->Branch("trk_mc_isFromCWeakDecayMuon", "std::vector<std::vector<int> >", &trk_mc_isFromCWeakDecayMuon, buff);
   tree->Branch("trk_mc_isDecayOnFlightMuon", "std::vector<std::vector<int> >", &trk_mc_isDecayOnFlightMuon, buff);
   tree->Branch("trk_mc_isFromChargePionMuon", "std::vector<std::vector<int> >", &trk_mc_isFromChargePionMuon, buff);
   tree->Branch("trk_mc_isFromChargeKaonMuon", "std::vector<std::vector<int> >", &trk_mc_isFromChargeKaonMuon, buff);
   
   tree->Branch("trk_mc_isPrimaryVertex", "std::vector<std::vector<int> >", &trk_mc_isPrimaryVertex, buff);
   tree->Branch("trk_mc_isSecondaryVertex", "std::vector<std::vector<int> >", &trk_mc_isSecondaryVertex, buff);
   tree->Branch("trk_mc_isTertiaryVertex", "std::vector<std::vector<int> >", &trk_mc_isTertiaryVertex, buff);
   
   tree->Branch("trk_mc_isUnknown", "std::vector<std::vector<int> >", &trk_mc_isUnknown, buff);
